...
public class W3CDomTest {
    ...
    public void simpleConversion() {
        ...
        com.grad.nodes.Document doc = Jsoup.parse(html);
    ...
    public void convertsGoogle() throws IOException {
        ...
        com.grad.nodes.Document doc = Jsoup.parse(in, "UTF8");
    ...
    public void namespacePreservation() throws IOException {
        ...
        com.grad.nodes.Document jsoupDoc;
        jsoupDoc = Jsoup.parse(in, "UTF-8");

        Document doc;
        com.grad.helper.W3CDom jDom = new com.grad.helper.W3CDom();

 ...
 */
package com.grad.htmlunit.core.activex.javascript.msxml;
...
import com.grad.htmlunit.core.javascript.configuration.JsxClass;
import com.grad.htmlunit.core.javascript.configuration.JsxFunction;
 ...
 * 
 * @see <a href="http://msdn.microsoft.com/en-us/library/ms760248.aspx">MSDN
 *      documentation</a>
 *
...
public class XMLDOMElement extends XMLDOMNode {
	...
	private Map<String, XMLDOMNodeList> elementsByTagName_; // for performance
															// and for equality
															// (==)
	...
	/**
	 * Creates the JS object for the property attributes. This object will the
	 * be cached.
	 * 
	...
	/**
	 * Returns a string that represents the element content. This will also
	 * include the text content from all child elements, concatenated in
	 * document order.
	 * 
	 ...
	 * @return the value of the specified attribute, {@code null} if the named
	 ...
	 * @param name
	 *            the name of the attribute to return
	 * @return the attribute node with the supplied name, {@code null} if the
	 ...
	 * 
	 * @param att
	 *            the attribute to be removed from this element
	 ...
	 *
	 * @param name
	 *            the name of the attribute; if the attribute with that name
	 *            already exists, its value is changed
	 * @param value
	 ...
	 * 
	 * @param newAtt
	 *            the attribute node to be associated with this element
	 ...
	 * 
	 * @param tagName
	 *            the name of the element to find; the tagName value '*' matches
	 *            all descendant elements of this element
	...
	/**
	 * Normalizes all descendant elements by combining two or more adjacent text
	 * nodes into one unified text node.
	 */
	@JsxFunction

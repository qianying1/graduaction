...
public class HtmlPage extends InteractivePage {
     ...
     * {@link com.grad.htmlunit.core.gargoylesoftware.htmlunit.WebClientOptions#setThrowExceptionOnFailingStatusCode(boolean)} is set
     * to true.
     */
    @Override
    ...
    */
     ...
     * (see {@link com.grad.htmlunit.core.gargoylesoftware.htmlunit.WebClientOptions#isJavaScriptEnabled()}.</p>

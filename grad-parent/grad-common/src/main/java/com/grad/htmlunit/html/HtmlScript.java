 ...
 */
package com.grad.htmlunit.html;
...
import com.grad.htmlunit.html.HtmlPage.JavaScriptLoadResult;
import com.grad.htmlunit.javascript.JavaScriptEngine;
import com.grad.htmlunit.javascript.PostponedAction;
import com.grad.htmlunit.javascript.host.Window;
import com.grad.htmlunit.javascript.host.dom.Document;
import com.grad.htmlunit.javascript.host.event.Event;
import com.grad.htmlunit.javascript.host.event.EventHandler;
import com.grad.htmlunit.javascript.host.html.HTMLDocument;
import com.grad.htmlunit.javascript.host.html.HTMLScriptElement;
...
public class HtmlScript extends HtmlElement {
    ...
    /**
     * @see com.grad.htmlunit.html.HtmlInput#asText()

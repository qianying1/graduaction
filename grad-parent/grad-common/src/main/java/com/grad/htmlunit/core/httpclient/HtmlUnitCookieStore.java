...
public final class HtmlUnitCookieStore implements CookieStore, Serializable {
    ...
    public synchronized void addCookie(final Cookie cookie) {
        manager_.addCookie(new com.grad.htmlunit.core.util.Cookie((ClientCookie) cookie));
    }
    ...
    public synchronized List<Cookie> getCookies() {
        if (manager_.isCookiesEnabled()) {
            return Arrays.asList(com.grad.htmlunit.core.util.Cookie.toHttpClient(manager_.getCookies()));
        }

package com.grad.jsoup.select;

import static com.grad.jsoup.internal.Normalizer.lowerCase;
...
import com.grad.jsoup.nodes.Comment;
import com.grad.jsoup.nodes.Document;
import com.grad.jsoup.nodes.DocumentType;
import com.grad.jsoup.nodes.Element;
import com.grad.jsoup.nodes.Node;
import com.grad.jsoup.nodes.XmlDeclaration;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<com.grad.jsoup.nodes.Attribute> values = element.attributes().asList();
            for (com.grad.jsoup.nodes.Attribute attribute : values) {

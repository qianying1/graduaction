package com.grad.select;

import static com.grad.internal.Normalizer.lowerCase;
import static com.grad.internal.Normalizer.normalize;

import java.util.List;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

import com.grad.helper.Validate;
import com.grad.nodes.Comment;
import com.grad.nodes.Document;
import com.grad.nodes.DocumentType;
import com.grad.nodes.Element;
import com.grad.nodes.Node;
import com.grad.nodes.XmlDeclaration;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<com.grad.nodes.Attribute> values = element.attributes().asList();
            for (com.grad.nodes.Attribute attribute : values) {
